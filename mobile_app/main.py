...
# --- Simple JSON file-based storage (replaces page.client_storage) ---
class AppStorage:
    """
    Persistent key-value storage using a JSON file.
    Works on Android via FLET_APP_STORAGE_DATA env var.
    Falls back to current directory on desktop.
    """
    def __init__(self):
...
def main(page: ft.Page):
    ...
    try:
        ...
        # Use file-based storage instead of page.client_storage
        storage = AppStorage()
